...
def reverse_map(*args, &block) #method takes arguemtns made into an array 
  args.reverse.map(&block) #those arguments are reverse and mapped out into a new array 
end
