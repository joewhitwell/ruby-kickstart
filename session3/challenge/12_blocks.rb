...
def pay_by(order)
  order.compute_cost #specificied methods
  order.compute_shipping #specificied methods
  order.compute_tax #specificied methods
  yield #executes the below blocks
